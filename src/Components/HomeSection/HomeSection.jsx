...
const HomeSection = () => {
    return (
        <div className='flex  md:flex-row lg:p-20 lg:px-36 md:p-0  max-sm:flex-col  justify-center max-sm:gap-8 lg:gap-56 w-full md:gap-56 items-center h-5/6 '>
            ...
            <div className='lg:w-1/2 md:w-full sm:w-full '>
                ...
                <span className='text-xl font-bold'>Full Stack Developer</span> */}
                    <div className='space-x-2 text-sm'>
                        <button className='p-2.5 px-5 border-black border rounded-3xl font-semibold'>Download CV</button>
                        <Link
