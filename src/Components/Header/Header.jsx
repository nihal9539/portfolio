    ...
    return (
        <div className={` h-1/6 flex flex-col`}>
            ...
            <div className={`${open ? "" : "hidden "} z-20`}>
                <ul className='transition-all ease-in-out duration-700 flex flex-col justify-center items-center gap-32 text-4xl font-semibold  h-screen  bg-white '>
                    <li><Link
                        to=''
                        span={true}
                        smooth={true}
                        className=' text-black ' href="">About</Link></li>
                    <li><Link
                    to='skills'
                    span={true}
                    smooth={true}
                    onClick={() => setOpen(!open)}
                    className=' text-black ' href="">Skills</Link> </li>
                    <li><Link className=' text-black ' href="">Projects</Link></li>
                    <li><Link to='contact_me'
                        onClick={() => setOpen(!open)}
                        span={true}
                        smooth={true}
                        className=' text-black ' href="">Contact</Link></li>
                </ul>
            </div>
        </div>
    )
